    ...
    <div name="contact" className="w-full h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
       <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
          ...
          <div className='flex justify-center items-center'>
            <form action="https://getform.io/f/937508d8-f60c-428a-8f9a-323dfc120bba" method="POST" className='flex flex-col w-full md:w-1/2'>
                ...
                <input type="text" email="name" placeholder='Enter your email' className='my-4 p-2 bg-transparent border-2
                rounded-md text-white focus:outline-none'/>
                {/**Use place holder to place default text in the text area */}
