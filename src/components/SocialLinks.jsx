...
const SocialLinks = () => {
    ...
    const links = [
        ...
        {id: 4,
            ...
            href:"../assets/Resume 9_21_22.pdf",
            download:true,
        }
  ...
  return (
    <div className="hidden lg:flex flex-col top-[35%] left-0 fixed">
        <ul>
            ...
            {links.map((link)=>( <li key={link.id} className="flex justify-between items-center w-40 h-14 px-4 ml-[-100px] bg-gray-500 hover:ml-[-10px]
